<x-layout>
    <x-slot:title>{{ $searchTerm ? 'Searching for: ' . $searchTerm : 'JoJo Fans' }}</x-slot:title>
    ...
    <div class="mb-12 relative z-10">
        <div class="bg-purple-900 p-8 jojo-border jojo-shadow relative overflow-hidden">
            ...
            <h2 class="text-5xl text-yellow-400 bangers transform -skew-x-6 tracking-widest drop-shadow-lg mb-6">COMMUNITY</h2>
